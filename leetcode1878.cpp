...
Approach:
1. Precompute prefix sums for both diagonals to quickly calculate rhombus edges.
2. For every cell treat it as the center of a rhombus.
3. Try all possible side lengths while staying inside the grid.
4. Compute rhombus border sums using diagonal prefix arrays.
5. Store sums in a set and keep only the largest three unique values.
